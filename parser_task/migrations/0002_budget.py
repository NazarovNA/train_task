    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentcode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='parser_task.budget', verbose_name='Вышестоящий бюджет')),
            ],
            options={
