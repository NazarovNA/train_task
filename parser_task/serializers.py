...
class AbstractSerializer(serializers.ModelSerializer):
    """
    Сериализатор предназначенный для обеспечения загрузки и обновления справочников из внешнего API.
    ...
    def get_code_field(self):
        """
        Метод позволяющий получить наименование полей json и модели, содержащих код, по котороому можно найти
