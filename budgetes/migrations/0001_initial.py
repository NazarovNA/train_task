    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentcode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='budgetes.budget', verbose_name='Вышестоящий бюджет')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='budgetes.budget', verbose_name='Бюджет')),
            ],
            options={
